...
const CheckoutScreen = () => {
  ...
  const totalItemCount = cart.reduce((sum, item) => sum + item.quantity, 0); // Calculate total item count
  ...
  // Removed downloadReceipt function

  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-festival-cream text-festival-charcoal-gray overflow-y-auto">
